          ...
          <ul class="event-list">
            ${i.actions.map(e=>{const i=s[e.action_id];return j`
                <li class=${i?.assigned?"on":""}>
                  <span class="ev-icon" title=${Ut[e.kind]}
                    >${Lt[e.kind]}</span
                  >
                  ...
                  ${(()=>{const i=this._automationEditPath(t.slots[e.action_id]);return i?this._iconButton("mdi:robot","Open in HA's automation editor",()=>this._navigate(i)):V})()}
