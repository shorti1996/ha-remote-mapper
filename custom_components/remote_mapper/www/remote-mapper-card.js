          ...
          <ul class="event-list">
            ${i.actions.map(t=>{const e=s[t.action_id];return j`
                <li class=${e?.assigned?"on":""}>
                  <span class="ev-icon" title=${Dt[t.kind]}
                    >${Lt[t.kind]}</span
                  >
